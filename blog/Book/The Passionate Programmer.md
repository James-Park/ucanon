...
색스폰 연주자로 컴퓨터 비전공자인 그가 불과 몇 년만에 프로그래머로 성공을 거두고, 다른 프로그래머에게 열정을 불러 일으키기 위해 이 책을 저술했다.

그와 나의 능력과 삶의 관점은 다르지만, 그의 열정이 나의 꺼져가는 열정을 다시 피어오르게 하는 불씨가 되어 주기에 이 책을 읽으며 나에게 남기고 싶은 글들을 따라 적어 본다.
